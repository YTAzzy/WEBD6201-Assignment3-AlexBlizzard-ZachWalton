...
(function () {
    ...
    function CheckLogin() {
        if (sessionStorage.getItem("user")) {
            ...
            $("#task-list").html(`<a id="task-list" class="nav-link" href="#"><i class="fas fa-clipboard"></i> Task List</a>`);

            $("#task-list").on("click", function () {
                $("#task-list").html(`<a class="nav-link" data="task-list"><i class="fas fa-clipboard"></i> Task List</a>`);
                AddNavigationEvents();
                LoadLink("task-list");
            ...
            $("#logout").on("click", function () {
                ...
                $("#task-list").html(`<a id="task-list" class="" href="#"><i class=""></i></a>`);
                AddNavigationEvents();
                LoadLink("login");
            });
        }
    ...
    function AddNewTask(taskTextInput){

        const taskInput = document.getElementById("taskTextInput");
        const addButton = document.getElementById("newTaskButton");
        ...
        addButton.addEventListener("click", () => {
            ...
            if (taskInput.value != ""){
                ...
                // Create the second span element with two buttons
                const buttonGroup = document.createElement("span");
                buttonGroup.classList.add("float-end");
                // Create the edit button
                const editButton = document.createElement("button");
                editButton.classList.add("btn", "btn-outline-primary", "btn-sm", "editButton");
                ...
                deleteButton.classList.add("btn", "btn-outline-danger", "btn-sm", "deleteButton");
                ...
                editInput.type = "text";
                editInput.classList.add("form-control", "edit-task", "editTextInput");
                newTask.appendChild(editInput);
                // Add the new list item to the task list
                taskList.appendChild(newTask);
                // Clear the task input text
                taskInput.value = "";
            }else {
                console.error("Cannot accept a blank Task!")
            }
        });
    }
    ...
    function ActiveLinkCallBack() {
        switch (router.ActiveLink) {
            ...
            case "task-list": return DisplayTaskPage;
